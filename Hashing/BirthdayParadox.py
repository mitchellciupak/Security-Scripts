#Credit: https://github.com/abiolasal/Birthday_Attack
# See also: https://github.com/AlexKaracaoglu/Topics-In-Computer-Systems-HW1/blob/master/birthdayAttack.py
# See also: https://www.geeksforgeeks.org/birthday-attack-in-cryptography/
...
print("python main.py -lhash 1200000")
